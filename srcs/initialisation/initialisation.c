...
/* Initializes the configuration structure (t_config) with the
simulation parameters provided by the user via the command-line input.
Returns true if all values are valid, false in case of overflow 
